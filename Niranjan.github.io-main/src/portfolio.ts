...
const seo = {
  title: "Alamure Niranjan Kumar",
  description:
    "A passionate individual who always thrives to work on end to end products which develop sustainable and scalable social and technical systems to create impact.",
  og: {
    title: "Alamure Niranjan Kumar",
    type: "website",
    url: "https://github.com/alaniranjan",
  },
};
...
const greeting = {
  ...
  subTitle:
    "A passionate individual who always thrives to work on end to end products which develop sustainable and scalable social and technical systems to create impact.",
  resumeLink:"",
  portfolio_repository: "https://github.com/alaniranjan",
  githubProfile: "https://github.com/alaniranjan",
};
...
const socialMediaLinks = [
  ...
  {
    name: "Github",
    link: "https://github.com/alaniranjan",
  ...
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/a-niranjan-017b05244/",
  ...
  {
    name: "Twitter",
    link: "https://twitter.com/AlamureNiranjan",
  ...
  data: [
    {
      img: "designtool.png",
      title: "UI DESIGNER",
      fileName: "UI Desigber",
      skills: [
        "⚡Proficient in industry-standard design tools such as Figma.",
        "⚡Figma in createing intuitive user interface and enhancing user experiences.",
        "⚡In prototyping and translating concepts into user-friendy designs.",
        "⚡Implemented consistent design system and style guides to maintain visual coherence across digital products.",
        "⚡Strong capacity for maintaining a focus on the end-user in all aspects of product design.",
        // "⚡Utilized microservices technology for modular and scalable frontend architecture.",
      ],
      softwareSkills: [
        {
          skillName: "Figma",
          fontAwesomeClassname:'ui.png',
          imgurl:'ui.png',
          style: {
            color: "#61DAFB",
          },
  ...
  data: [
    {
      ...
      isFork: false,  
      link: "https://e-commerce-web-wj1m.onrender.com",
      languages: [
        {
          name: "React.js",
    ...
    },
    {
      ...
      isFork: false,
      link: "https://foodie-blog-starter.onrender.com/",
      languages: [
        {
          name: "HTML",
...
const contactPageData = {
  contactSection: {
    title: "Contact Me",
    profile_image_path: "niranjan.jpeg",
    description:
  ...
  blogSection: {
    ...
    link: "https://medium.com/@alamureniranjan",
    avatar_image_path: "blog.png",
  },
  addressSection: {
    title: "Address",
    subtitle: "I'm originally from Kadiri, but I currently live in Bangalore.",
    avatar_image_path: "address.png",
    // location_map_link: "https://www.google.com/maps/@28.5006897,77.3152116,12z",
  },
  phoneSection: {
    name: "Phone Number",
    number: "+91 9392477974",
  },
};
